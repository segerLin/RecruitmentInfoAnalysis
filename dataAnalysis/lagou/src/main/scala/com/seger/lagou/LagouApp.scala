...
import com.seger.lagou.service.{CompanyService, JobAreaService, JobNameService, JobTypeService, OtherService, AreaService}
...
object LagouApp {
  ...
  def main(args: Array[String]): Unit = {
    //获得实例
    val spark = SparkSession.builder().appName("LagouApp").master("local[4]").getOrCreate()

    //获取数据集
    val path = "/Users/seger/Documents/PDF/job.json"
    val provincePath = "/Users/seger/Documents/PDF/province.json"
    val cityPath = "/Users/seger/Documents/PDF/city.json"
...
//      jobExperienceAndSalaryDF.show(10)
      jobExperienceAndSalaryDF.write.mode(SaveMode.Overwrite).json("/Users/seger/Documents/Coding/Java/IdeaProject/lagou/data/jobExperienceAndSalaryDF/"+ keyword)
    }
...
//      jobExperienceDstriDF.show()
      jobExperienceDstriDF.write.mode(SaveMode.Overwrite).json("/Users/seger/Documents/Coding/Java/IdeaProject/lagou/data/jobExperienceDstri/"+ keyword)
    }
...
//      jobExperienceDstriDF.orderBy($"job_num".desc).show()
      jobExperienceDstriDF.write.mode(SaveMode.Overwrite).json("/Users/seger/Documents/Coding/Java/IdeaProject/lagou/data/jobSalaryAboutCity/"+ keyword)
    }


    def createProvinceSQL(): Unit ={
      AreaService.provinceDFService(provinceDF)
    }

    def createCitySQL(): Unit ={
      AreaService.cityDFService(cityDF)
    }
...
//    var keyWords = "后端开发,Java,C++,PHP,数据挖掘,搜索算法,精准推荐,C,C#,全栈工程师,.NETHadoop,Python,Delphi,VB,Perl,Ruby,Node.js,Go,ASP,Shell,区块链,HTML5,Android,iOS,WP,移动开发,前端,JavaScript,U3D,COCOS2D-X,人工智能,深度学习,机器学习,图像处理,图像识别,语音识别,机器视觉,算法工程师,自然语言处理,运维工程师,运维开发工程师,网络工程师,系统工程师,IT支持,IDC,CDN,F5系统管理员,病毒分析,WEB安全,网络安全,系统安全,运维经理,MySQL,SQLServer,Oracle,DB2,MongoDB,ETL,Hive,数据仓库,技术经理,技术总监,架构师,CTO,运维总监,技术合伙人,项目总监,测试总监,安全专家,项目经理,项目助理,产品经理,游戏制作,视觉设计师,网页设计师,Flash设计师,APP设计师,UI设计师,平面设计师美术设计师（2D/3D）,广告设计师,多媒体设计师,原画师,游戏特效,游戏界面设计师,游戏场景,游戏角色,游戏动作,交互设计师,无线交互设计师,网页交互设计师,硬件交互设计师,数据分析师,用户研究员,游戏数值策划,设计经理/主管,设计总监,视觉设计经理/主管,视觉设计总监,交互设计经理/主管交互设计总监,用户研究经理/主管,用户研究总监,用户运营,产品运营,数据运营,内容运营,活动运营,商家运营,品类运营游戏运营,网络推广,运营专员,网店运营,新媒体运营,海外运营,运营经理,人力资源,招聘,HRBP,人事/HR,培训经理,薪资福利经理,绩效考核经理员工关系,行政总监/经理,财务总监/经理,HRD/HRM,CFO,CEO"
